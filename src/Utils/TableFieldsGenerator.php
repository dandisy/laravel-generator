...
use Webcore\Generator\Common\GeneratorFieldRelation;
...
class TableFieldsGenerator
{
    ...
    public function __construct($tableName)
    {
        ...
        $this->defaultSearchable = config('webcore.laravel_generator.options.tables_searchable_default', false);
    }
    ...
    {
        if (!config('webcore.laravel_generator.timestamps.enabled', true)) {
            return [];
        }

        $createdAtName = config('webcore.laravel_generator.timestamps.created_at', 'created_at');
        $updatedAtName = config('webcore.laravel_generator.timestamps.updated_at', 'updated_at');
        $deletedAtName = config('webcore.laravel_generator.timestamps.deleted_at', 'deleted_at');
