...
namespace Webcore\Generator\Commands;

use Illuminate\Console\Command;
use Webcore\Generator\Common\CommandData;
use Webcore\Generator\Generators\API\APIControllerGenerator;
use Webcore\Generator\Generators\API\APIRequestGenerator;
use Webcore\Generator\Generators\API\APIRoutesGenerator;
use Webcore\Generator\Generators\API\APITestGenerator;
...
use Webcore\Generator\Generators\RepositoryTestGenerator;
use Webcore\Generator\Generators\Scaffold\ControllerGenerator;
use Webcore\Generator\Generators\Scaffold\MenuGenerator;
use Webcore\Generator\Generators\Scaffold\RequestGenerator;
use Webcore\Generator\Generators\Scaffold\RoutesGenerator;
use Webcore\Generator\Generators\Scaffold\ViewGenerator;
use Webcore\Generator\Generators\TestTraitGenerator;
...
class BaseCommand extends Command
{
    ...
    private function saveSchemaFile()
    {
        ...
        $path = config('webcore.laravel_generator.path.schema_files', base_path('resources/model_schemas/'));
    ...
    public function getOptions()
    {
        return [
            ...
            ['logs', null, InputOption::VALUE_NONE, 'Generate created_by and updeted_by fields'], // added by dandisy
            ['queryToAPI', null, InputOption::VALUE_NONE, 'CRUD using CURL to access backend API'], // added by dandisy
        ];
    }
