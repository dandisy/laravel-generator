...
@section('scripts')
    ...
    <script>
        ...
        $("#gridContainer").dxDataGrid({
            dataSource: @json($quotationHeaders),
            ...
            columns: [
                ...
                // },
                {
                    dataField: 'mitra_bisnis_id',
                    caption: 'Mitra Bisnis',
                    calculateDisplayValue: "mitra_bisnis.name"
                },
                {
                    dataField: "file",
                ...
                },
                {
                    ...
                    caption: 'Purchase Order File',
                    calculateDisplayValue: "purchase_order.file"
                },
                // {
                //     dataField: "checked",
                //     sortOrder: "asc"
                ...
                //             .text('Edit')
                //             .on('dxclick', function () {
                //                 window.location = '{{url("quotationHeaders")}}/'+cellInfo.data.id+'/edit'
                //             })
                ...
                //             .text('Approve')
                //             .on('dxclick', function () {
                //                 window.location = '{{url("quotationHeaders")}}/'+cellInfo.data.id+'/approve'
                //             })
                //             .appendTo(cellElement);
                //         // $('<a/>').attr('data-key', cellInfo.data.id).dxButton({
                //         //     text: "Edit",
                ...
                //             .text('Reject')
                //             .on('dxclick', function () {
                //                 window.location = '{{url("quotationHeaders")}}/'+cellInfo.data.id+'/reject'
                //             })
                //             .appendTo(cellElement);
                //         // $('<a/>').attr('data-key', cellInfo.data.id).dxButton({
                //         //     text: "Edit",
            ...
            onCellPrepared: function (e) {
                if (e.rowType === "data" && e.column.command === "edit") {
                    ...
                    //             .text('Checking...')
                    //             .on('dxclick', function () {
                    //                 window.location = '{{url("quotationHeaders")}}/'+e.row.data.id
                    //             })
                    ...
                    //         .text('Reject')
                    //         .on('dxclick', function () {
                    //             window.location = '{{url("quotationHeaders")}}/'+e.row.data.id+'/reject'
                    //         })
                    //         .prependTo(e.cellElement);
                    //     e.cellElement.prepend('&nbsp;');
                    //     $('<a/>').addClass('dx-link text-success')
                    //         .text('Approve')
                    //         .on('dxclick', function () {
                    //             window.location = '{{url("quotationHeaders")}}/'+e.row.data.id+'/approve'
                    //         })
                    //         .prependTo(e.cellElement);
                    //     e.cellElement.prepend('&nbsp;');
                    //     $('<a/>').addClass('dx-link text-info')
                    ...
                    // } else {--}}
                        ...
                        //     .text('Edit')
                        //     .on('dxclick', function () {
                        //         window.location = '{{url("quotationHeaders")}}/'+e.row.data.id+'/edit'
                        //     })
                        //     .prependTo(e.cellElement);
                        // {{--@endrole--}}
                        // {{--@role('checker')--}}
                        ...
                        e.cellElement.prepend('&nbsp;');
                        e.cellElement.prepend('&nbsp;');
                        $('<a/>').addClass('dx-link btn btn-default btn-sm')
                            .text('Create Sales Order')
                            .on('dxclick', function () {
                                // window.location = '{{url("salesOrders/product")}}/'+e.row.data.id
                                window.location = '{{url("products")}}?quo='+e.row.data.id
                            })
                            .prependTo(e.cellElement);
                        // {{--@endrole--}}
                    // {{--}--}}
            ...
            //     //     }
            //     //     else {
            //     //         var filtered = @json($quotationHeaders).filter(function(s) {
            ...
            //         }
            //     });
            //     var cek = @json($quotationHeaders).filter(function(s) {
            //         return s.checked == null;
            //     });
            //     if(cek.length != 0){
            //         $('.btn-select').show();
